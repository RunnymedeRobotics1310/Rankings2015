...
public class RankingsBlueAlliance {
	...
	public RankingsBlueAlliance(String fileName) {
		this.fileName = fileName;
	}
	
	public static void main(String[] args) {
		if (args.length < 1) {
			System.out.println("Usage " + RankingsBlueAlliance.class.getSimpleName() + " inputFileMatchStats");
			System.exit(-1);
		}
		
		(new RankingsBlueAlliance(args[0])).run();
